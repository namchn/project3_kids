...
public class NoticeBoardController {
	...
	public ModelAndView noticeView(@RequestParam(value = "notice_num") int num,
	...
	public ModelAndView noticeEditForm(@RequestParam(value = "notice_num") int num,
			@RequestParam(value = "sort") String sort) {
	...
	public ModelAndView noticeEdit(NoticeBoard nb, @RequestParam("sort") String sort) {
		...
		if (nb.getNotice_files() != null) {
			...
			nb.setFiles("");
			System.out.println("nb.getNotice_files()이 널입니당");
		}
		System.out.println(nb.getNotice_files());
		System.out.println("nb출력함니당" + nb);
	...
	public ModelAndView noticeDelete(@RequestParam(value = "notice_num") int num,
			@RequestParam(value = "sort") String sort) {
	...
	public ModelAndView noticeSearchResult(PagingVO paging, @RequestParam(value = "search_type") int search_type,
	...
	public ModelAndView noticeReplyWrite(@RequestParam(value = "notice_num") int notice_num,
			@RequestParam(value = "id") String id, @RequestParam(value = "content") String content) {
		Reply r = new Reply();
	...
	public ModelAndView noticeReplyEdit(@RequestParam(value = "notice_num") int notice_num,
			@RequestParam(value = "reply_num") int reply_num, @RequestParam(value = "content") String content) {
		Reply r = new Reply();
		r.setReply_num(reply_num);
		r.setContent(content);
	...
	public ModelAndView noticeReplyDelete(@RequestParam(value = "notice_num") int notice_num,
			@RequestParam(value = "reply_num") int reply_num) {
