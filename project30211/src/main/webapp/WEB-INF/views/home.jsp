      ...
      <div data-layout="_r">
         <div data-layout="ch8 ec4">
            <a href="${pageContext.request.contextPath}/boardDiet/detailDiet?diet_num=${db.diet_num}"
               ...
               <a href="${pageContext.request.contextPath}/boardDiet/detailDiet?diet_num=${db.diet_num}"
               class="MOD_FEATURE_Container">
                  <h2 align="center">식단표</h2> <img src="/img/${db.files}"
                  width="150" height="150" alt="식단표 업로드 불가">
...
<%--          </div>
      ...
      <div style="padding-bottom:10px; height: 270px; width: 570px; border: 1px solid lightgray;">
