...
<div class="container">
  ...
  <input type="submit" value="삭제" onclick="deleteCal()">
  <%-- <input type="button" value="수정" onclick="location.href='${pageContext.request.contextPath}/manager/calendarEditForm?num=${allc.num }'">  --%>
  <input type="submit" value="수정" onclick="editCal()"> 
  <input type="button" value="업로드" onclick="location.href='${pageContext.request.contextPath}/manager/calendarUploadForm'">
