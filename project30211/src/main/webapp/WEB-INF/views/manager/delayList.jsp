...
<div class="container" style="margin-top:50px; margin-left: 22%;">
  ...
  <a class="glyphicon glyphicon-check" style="font-size: 12px; color: green; text-decoration:none"></a><a style="font-size: 13px; font-weight: bolder;">연체중&nbsp;</a>
...
<!-- 5. paging view -->    
      ...
      <form action="${pageContext.request.contextPath}/manager/delayList" method="post" id="frmPaging">
