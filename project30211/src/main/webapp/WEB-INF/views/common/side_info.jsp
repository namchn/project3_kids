...
<!-- 측면 메뉴바 -->
    <div data-layout="al16 al-o2 de-o1 de6 ec4" style="position: absolute; width: 10%;" id="side1">
      ...
      <nav class="MOD_SUBNAVIGATION1_Menu" data-theme="_bo2"  style="background-color: #F9F5B3;" >
        <p class="MOD_SUBNAVIGATION1_Menutitle" data-theme="_bgs" style="background-color: #f9ca5b; ">유치원 소개</p>
        <ul>
          <li><a href="${pageContext.request.contextPath }/introduce/introduce">유치원 소개</a></li>
          <li><a href="${pageContext.request.contextPath }/introduce/applicants">모집 요강</a></li>
