	...
	<div data-layout="al16 al-o2 de-o1 de6 ec4" style="position: absolute; width:10%">
		<div data-layout="ch-half">
			<nav class="MOD_SUBNAVIGATION1_Menu" data-theme="_bo2">
				<p class="MOD_SUBNAVIGATION1_Menutitle" data-theme="_bgs">도서관</p>
				<ul>
					<li><a
						href="${pageContext.request.contextPath }/book/booklistForm"
						>도서목록</a></li>
					<li><a
						href="${pageContext.request.contextPath }/book/myCart"
						>내 찜 도서</a></li>
					<li><a
						href="${pageContext.request.contextPath }/book/myrent"
						>내 대출 목록</a></li>
